        ...
        itemBuilder: (ctx, index) {
          return ListTile(
            ...
            trailing: Container(
              ...
              decoration:
                  BoxDecoration(borderRadius: BorderRadius.circular(5),color: type=='Pending'? Colors.red:Colors.green,),
              child: Text(type,style: GoogleFonts.poppins( color: type=="Pending"? Colors.black:Colors.white,fontSize: size.width*.03,fontWeight: FontWeight.w600),
                ),
            ),
          );
        });
